...
String manyphone=request.getParameter("manyphone");
...
try{
	...
	ResultSet rs=stmt.executeQuery("select idphone from phonestock1");
	String id=null;
	if(con!=null){

	
		String sql="update phonestock1 set idphone='"+idphone+"', manyphone="+manyphone+" ,pricephone='"+pricephone+"' where idphone='"+idphone+"'";

		int  return_val=stmt.executeUpdate(sql);
if(return_val==1){out.print("เพิ่มข้อมูลเรียบร้อยแล้ว!!!<br>");
		out.print("<a href=\"selectphone.jsp\">ดูข้อมูลทั้งหมด</a>");
}else{
