...
<nav class="nav" >
  ...
  <div class="nav-right nav-menu" href="phoneindex.jsp">
    <a class="nav-item">
      Home
    </a>
    <a class="nav-item">
...
<aside class="menu">
  ...
  <ul class="menu-list">
  <li><a href="samsung.jsp">SAMSUNG</a></li><!--  class="is-active" -->
    <li><a href="IPHONE.jsp"  class="is-active" >IPHONE</a></li>
    <li><a href="OPPO.jsp">OPPO</a></li>
    <li><a href="HUAWEI.jsp"  >HUAWEI</a></li>
    <li><a href="ASUS.jsp">ASUS</a></li>
    <li><a href="MOTOROLA.jsp">MOTOROLA</a></li>
